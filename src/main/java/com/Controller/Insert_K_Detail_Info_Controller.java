...
public class Insert_K_Detail_Info_Controller implements Command {
	...
	public void command(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		K_Detail_Info_DTO dto = new K_Detail_Info_DTO(numbering, k_salinity, k_indoor_temp, 
				k_water_temp, k_wire_temp, k_water_high, k_daily_prod, k_harvest, k_place_size,
				k_indoor_humid, k_automode, node);
