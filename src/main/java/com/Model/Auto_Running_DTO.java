...
public class Auto_Running_DTO {
	...
	private int stalinity_run;
	private int waterhigh_run;
	
	
	public Auto_Running_DTO(int numbering, int fan_run, int pump_run, int wire_run, int light_run, int stalinity_run,int waterhigh_run) {
		this.numbering = numbering;
		this.fan_run = fan_run;
		this.pump_run = pump_run;
		this.wire_run = wire_run;
		this.light_run = light_run;
		this.stalinity_run = stalinity_run;
	...
	public int getWaterhigh_run() {
		return waterhigh_run;
	}

	public void setWaterhigh_run(int waterhigh_run) {
		this.waterhigh_run = waterhigh_run;
	}
	...
	public int getStalinity_run() {
		return stalinity_run;
	}


	public void setStalinity_run(int stalinity_run) {
		this.stalinity_run = stalinity_run;
	}
